...
public class ReserveController {
	...
	@RequestMapping(value="jsonSelectionOption.web", method=RequestMethod.GET)
	@ResponseBody
	public String jsonSelectionOption(@ModelAttribute Pumyigs pumyigs) throws Exception{
		return JsonUtil.marshallingJson(this.reserveService.findSelectionOption(pumyigs));
	}
